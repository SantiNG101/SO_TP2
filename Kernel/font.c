...
// https://github.com/eprive/STM32Lvideo/blob/master/src/font6x10.c
...
const uint8_t gdiSystemFont[][CHAR_HEIGHT] = {
//  32 $20 'space'
...
// Se agregaron numeros pas grandes para el PONG, pues si no no se veian bien en pantalla
...
uint8_t * charBitmap(uint8_t character){
	return gdiSystemFont[character-' '];
}

uint8_t * numberBitmap( uint8_t number ){
	return numbersXL[number-'0'];
}